 ...
 * Used to test basic chart templates in html views. 
 * @author Bojan
 *
 */
@Deprecated
public class CanvasjsChartData {
	...
	static {
		...
		map = new HashMap<Object,Object>(); map.put("x", 1388514600000L); map.put("y", 152);dataPoints1.add(map);
		map = new HashMap<Object,Object>(); map.put("x", 1420050600000L); map.put("y", 129);dataPoints1.add(map);
		map = new HashMap<Object,Object>(); map.put("x", 1451586600000L); map.put("y", 155);;dataPoints1.add(map);
